...
const FloatingAI = () => {
  ...
  const [messages, setMessages] = useState<Msg[]>([
    { role: "assistant", content: "Hi — I'm Shreejan's AI assistant. Ask me anything about his work, skills, or how to get in touch." },
  ]);
  ...
  return (
    <>
      ...
      <button
        onClick={() => setOpen((o) => !o)}
        aria-label={open ? "Close AI assistant" : "Ask Shreejan's AI"}
        ...
        >
          <div className="flex items-center justify-between px-5 py-4" style={{ borderBottom: "1px solid var(--line)" }}>
            <div className="flex items-center gap-3">
              ...
              <span className="font-mono-syne" style={{ color: "var(--accent)" }}>Shreejan's AI</span>
            </div>
